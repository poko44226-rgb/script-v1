...
-- [[ MINECRAFT WITHER BOSS - SIT FLING EDITION V7.3.4 - 1V1 BLOCK ]] --
...
local SOAK_GRACE_TIME = 2.5 -- ช่วง grace: ลากเต็มที่ก่อน ค่อยเริ่มเช็คว่าเป้าหลุดหรือยัง
-- ===================================
...
titleLabel.BackgroundTransparency, titleLabel.Text = 1, "Wither Sit-Fling V7.3.4 | 1V1"
