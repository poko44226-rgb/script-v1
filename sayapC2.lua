...
local COLOR_THEMES = {
    {Name = "GOLD",    Shade = Color3.fromRGB(80, 60, 10),   Toxic = Color3.fromRGB(255, 215, 0),   Deep = Color3.fromRGB(180, 135, 30)}, -- ต้นฉบับ sayapC
    {Name = "RED",     Shade = Color3.fromRGB(80, 0, 0),     Toxic = Color3.fromRGB(255, 0, 0),     Deep = Color3.fromRGB(160, 0, 0)},
    {Name = "ORANGE",  Shade = Color3.fromRGB(80, 30, 0),    Toxic = Color3.fromRGB(255, 120, 0),   Deep = Color3.fromRGB(180, 80, 0)},
    {Name = "YELLOW",  Shade = Color3.fromRGB(80, 80, 0),    Toxic = Color3.fromRGB(255, 255, 0),   Deep = Color3.fromRGB(190, 190, 0)},
    {Name = "LIME",    Shade = Color3.fromRGB(35, 80, 0),    Toxic = Color3.fromRGB(130, 255, 0),   Deep = Color3.fromRGB(90, 180, 0)},
    {Name = "GREEN",   Shade = Color3.fromRGB(0, 80, 0),     Toxic = Color3.fromRGB(0, 255, 0),     Deep = Color3.fromRGB(0, 170, 0)},
    {Name = "CYAN",    Shade = Color3.fromRGB(0, 80, 80),    Toxic = Color3.fromRGB(0, 255, 255),   Deep = Color3.fromRGB(0, 170, 170)},
    {Name = "BLUE",    Shade = Color3.fromRGB(0, 0, 80),     Toxic = Color3.fromRGB(0, 140, 255),   Deep = Color3.fromRGB(0, 90, 170)},
    {Name = "PURPLE",  Shade = Color3.fromRGB(50, 0, 80),    Toxic = Color3.fromRGB(170, 0, 255),   Deep = Color3.fromRGB(110, 0, 170)},
    {Name = "MAGENTA", Shade = Color3.fromRGB(80, 0, 60),    Toxic = Color3.fromRGB(255, 0, 220),   Deep = Color3.fromRGB(180, 0, 150)},
    {Name = "PINK",    Shade = Color3.fromRGB(80, 0, 40),    Toxic = Color3.fromRGB(255, 0, 160),   Deep = Color3.fromRGB(180, 0, 110)},
    {Name = "SILVER",  Shade = Color3.fromRGB(70, 70, 70),   Toxic = Color3.fromRGB(230, 230, 230), Deep = Color3.fromRGB(140, 140, 140)},
}
...
local function getAbyssColor(t, offset)
    ...
    if cycle < 0.5 then
        return white:Lerp(getCol("Toxic"), cycle * 2)
    else
        return getCol("Toxic"):Lerp(getCol("Deep"), (cycle - 0.5) * 2)
    end
end
-- =======================================================================
...
local function updateMainGradient()
    MainGrad.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, getCol("Shade")),
...
local function applyTheme()
    ...
    TargetBtn.BackgroundColor3 = activeTargeting and getCol("Shade") or Color3.fromRGB(0, 0, 0)
    PetBtn.BackgroundColor3 = petMode and getCol("Shade") or Color3.fromRGB(0, 0, 0)
end
