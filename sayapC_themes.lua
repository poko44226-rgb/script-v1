...
local function getAbyssColor(t, offset)
    ...
    if cycle < 0.5 then
        return getCol("Abyss"):Lerp(getCol("Toxic"), cycle * 2)
    else
...
local ColorBtn = createBtn("COLOR: RED")
...
local function applyTheme()
    ...
    TargetBtn.BackgroundColor3 = activeTargeting and getCol("Abyss") or Color3.fromRGB(0, 0, 0)
    PetBtn.BackgroundColor3 = petMode and getCol("Abyss") or Color3.fromRGB(0, 0, 0)
end
