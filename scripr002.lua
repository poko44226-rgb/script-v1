...
ColorPickerFrame.Size = UDim2.fromOffset(250, 235)
...
colorContainer.Size = UDim2.new(1, -20, 1, -48)
colorContainer.Position = UDim2.fromOffset(10, 42)
colorContainer.BackgroundTransparency = 1

local gridLayout = Instance.new("UIGridLayout", colorContainer)
gridLayout.CellSize = UDim2.fromOffset(52, 43)
...
local function setColorPickerVisible(visible)
    ...
    if visible then
        ...
        local pickerW, pickerH, gap = 250, 235, 10
...
for index, theme in ipairs(COLOR_THEMES) do
    ...
    colorBtn.Size = UDim2.fromOffset(52, 43)
