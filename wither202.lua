...
-- [[ MINECRAFT WITHER BOSS - SIT FLING EDITION V7.1.2 ]] --
...
titleLabel.BackgroundTransparency, titleLabel.Text = 1, "Wither Sit-Fling V7.1.2"
        ...
        for auraId, projData in pairs(activeProjectiles) do
            ...
            if currentEnemyTorso then
                ...
                if projData.IsStuck then
                    ...
                    local lingerLimit = sitFlingMode and (SIT_FLING_HOLD_TIME + SIT_FLING_SOAK_TIME) or IMPACT_LINGER_TIME
                    if t - projData.ImpactTime >= lingerLimit then
