...
local function Button15()
    loadstring(game:HttpGet("https://pastefy.app/8oXtJqyl/raw"))()
end
...
local function Button24()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/poko44226-rgb/script-v1/refs/heads/main/trap_void_v3.lua"))()
end
...
local function Button29()
    loadstring(game:HttpGet("https://pastefy.app/2Hu2zXoQ/raw"))()
end
...
local function Button32()
    ...
    if setclipboard then
        ...
        notification.Text = "Telegram link copied!"
