...
-- [[ MINECRAFT WITHER BOSS - SIT FLING EDITION V7.1.1 ]] --
...
titleLabel.BackgroundTransparency, titleLabel.Text = 1, "Wither Sit-Fling V7.1.1"
        ...
        for auraId, projData in pairs(activeProjectiles) do
            ...
            if currentEnemyTorso then
                ...
                if projData.IsStuck then
                    ...
                    local lingerLimit = sitFlingMode and (SIT_FLING_HOLD_TIME + IMPACT_LINGER_TIME) or IMPACT_LINGER_TIME
