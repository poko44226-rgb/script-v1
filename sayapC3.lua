...
local COLOR_THEMES = {
    {Name = "GOLD",    Base = Color3.fromRGB(255, 255, 255), Main = Color3.fromRGB(255, 215, 0),   Deep = Color3.fromRGB(180, 135, 30)}, -- ต้นฉบับ sayapC
    {Name = "RED",     Base = Color3.fromRGB(12, 12, 12),    Main = Color3.fromRGB(255, 0, 0),     Deep = Color3.fromRGB(12, 12, 12)},
    {Name = "ORANGE",  Base = Color3.fromRGB(18, 10, 4),     Main = Color3.fromRGB(255, 120, 0),   Deep = Color3.fromRGB(18, 10, 4)},
    {Name = "YELLOW",  Base = Color3.fromRGB(16, 16, 6),     Main = Color3.fromRGB(255, 255, 0),   Deep = Color3.fromRGB(16, 16, 6)},
    {Name = "LIME",    Base = Color3.fromRGB(10, 16, 4),     Main = Color3.fromRGB(130, 255, 0),   Deep = Color3.fromRGB(10, 16, 4)},
    {Name = "GREEN",   Base = Color3.fromRGB(4, 16, 4),      Main = Color3.fromRGB(0, 255, 0),     Deep = Color3.fromRGB(4, 16, 4)},
    {Name = "CYAN",    Base = Color3.fromRGB(0, 28, 32),     Main = Color3.fromRGB(0, 255, 255),   Deep = Color3.fromRGB(0, 28, 32)},
    {Name = "BLUE",    Base = Color3.fromRGB(6, 12, 30),     Main = Color3.fromRGB(0, 140, 255),   Deep = Color3.fromRGB(6, 12, 30)},
    {Name = "PURPLE",  Base = Color3.fromRGB(16, 5, 22),     Main = Color3.fromRGB(170, 0, 255),   Deep = Color3.fromRGB(16, 5, 22)},
    {Name = "MAGENTA", Base = Color3.fromRGB(20, 5, 16),     Main = Color3.fromRGB(255, 0, 220),   Deep = Color3.fromRGB(20, 5, 16)},
    {Name = "PINK",    Base = Color3.fromRGB(20, 5, 12),     Main = Color3.fromRGB(255, 0, 160),   Deep = Color3.fromRGB(20, 5, 12)},
    {Name = "SILVER",  Base = Color3.fromRGB(14, 14, 14),    Main = Color3.fromRGB(215, 215, 225), Deep = Color3.fromRGB(14, 14, 14)},
}
