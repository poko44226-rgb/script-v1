...
-- [[ MINECRAFT WITHER BOSS - SIT FLING EDITION V7.2.1 ]] --
...
titleLabel.BackgroundTransparency, titleLabel.Text = 1, "Wither Sit-Fling V7.2.1"
                    ...
                    if sitFlingMode then
                        if not projData.VoidDragStarted then
                            ...
                            if t - projData.ImpactTime >= SIT_FLING_HOLD_TIME then
                                ...
                                -- ล็อกจุดยึดไว้บนเกาะ (ตำแหน่งเป้าตอนเริ่มลาก) วิเทอร์จะได้ไม่ตามลงเหว
